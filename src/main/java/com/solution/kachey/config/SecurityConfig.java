    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/login", "/api/auth/register").permitAll()  // Auth endpoints should be accessible by anyone
                        .requestMatchers("/api/users/profile").authenticated()  // Profile endpoint requires authentication
                        .requestMatchers("/api/permission/add-permission").hasRole("SUPER_ADMIN")  // Only accessible to SUPER_ADMIN role
